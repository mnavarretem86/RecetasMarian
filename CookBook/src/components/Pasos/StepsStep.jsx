...
const StepsStep = ({
 ...
 // Lógica de validación: el botón estará deshabilitado si no hay pasos o si isLoading es true
 const isSaveButtonDisabled = !currentRecipe.pasos || currentRecipe.pasos.length === 0 || isLoading;
  ...
  <>
   ...
   <div className="form-navigation full-width-align">
    ...
    <div className="right-buttons">
     ...
     <button type="button" onClick={handleSaveRecipe} className="save-btn" disabled={isSaveButtonDisabled}>
